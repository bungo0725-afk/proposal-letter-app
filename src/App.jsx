...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
  ...
  const downloadPDF = async () => {
    ...
    const options = {
      margin: [15, 15, 15, 15],
      filename: `提案手紙_${proposalLetter.owner}_${new Date().getTime()}.pdf`,
    ...
    <div style={{ backgroundColor: '#0f172a', color: '#e2e8f0', minHeight: '100vh', padding: '15px' }}>
      ...
      {activeTab === 'preview' && proposalLetter && (
        <div>
          ...
          <div id="pdf-content" style={{ position: 'fixed', top: 0, left: '-9999px', width: '800px', backgroundColor: '#ffffff', color: '#000000', padding: '40px', opacity: 0, zIndex: -1000 }}>
